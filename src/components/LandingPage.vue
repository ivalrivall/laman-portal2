            ...
            <div class="d-flex align-items-center">
              <div class="d-block">
                <p class="container-resi_text-title pb-0">
                  Nova Content Management System
                </p>
          ...
          <b-col>
            <div style="max-width: 400px">
              ...
              <p style="font-size: 14px">
                ...
                voluptatum amet rerum, vero consequatur, accusamus perspiciatis
                voluptatibus eum.
              </p>
            </div>
          </b-col>
...
export default {
  ...
  //   async checkResi() {
  //     try {
  //       const { data: response } = await this.$axios.post(`tracking/resi`, {
  //         number: this.number
  //       });
  //       this.$store.dispatch("general/setResi", response.data);
  //     } catch (error) {
